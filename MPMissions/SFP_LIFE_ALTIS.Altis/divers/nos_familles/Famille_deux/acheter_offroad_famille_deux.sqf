...
if (isnil {player getvariable sfp_config_famille_deux_nom_pour_variable}) exitwith {hint format ["! %1 ! \n --------------------------------------- \n\n Bonjour, \n Vous ne pouvez pas acheter de véhicule ici puisque vous ne faite pas partie de notre famille.\n\n Cordialement.", sfp_config_famille_deux_nom];};

argent_actuellement = player getVariable "mon_argent_banque_by_sfp_maxou";
carspawn = getMarkerPos "spawn_vehicule_famille_deux";
le_nom_de_larticle = format ["un véhicule spécial %1", sfp_config_famille_deux_nom];
vehname = sfp_config_famille_deux_classe_du_vehicule_perso_un select 1;
le_prix_de_larticle = sfp_config_famille_deux_classe_du_vehicule_perso_un select 2;
