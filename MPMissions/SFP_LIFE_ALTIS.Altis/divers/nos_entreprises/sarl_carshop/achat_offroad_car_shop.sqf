...
if (isnil {player getvariable "sarl_car_shop"}) exitwith {hint "! SARL CAR SHOP ! \n --------------------------------------- \n\n Bonjour, \n Vous ne pouvez pas acheter de véhicule ici puisque vous ne faite pas partie de notre entreprise.\n\n Cordialement.";};
if (player in list sarlcarshop_Neochori) then {carspawn = getMarkerPos "car_shop_spawn_vehicule";};
argent_actuellement = player getVariable "mon_argent_banque_by_sfp_maxou";
le_nom_de_larticle = "un Offroad spéciale SARL CAR SHOP";
le_prix_de_larticle = 520;
vehname = "Offroad_01_car_shop_sfp";
