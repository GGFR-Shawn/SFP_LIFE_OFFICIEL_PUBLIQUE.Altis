...
carspawn = getMarkerPos "voiture_sarl_pompier_un";
le_nom_de_larticle = "une hatchback spéciale SARL POMPIER";
le_prix_de_larticle = 352;
vehname = "C_Hatchback_01_sport_F";
