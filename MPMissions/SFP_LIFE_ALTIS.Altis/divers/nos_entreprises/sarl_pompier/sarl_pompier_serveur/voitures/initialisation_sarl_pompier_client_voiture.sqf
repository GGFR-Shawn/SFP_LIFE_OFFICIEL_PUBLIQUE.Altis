...
{
	["Incendie",["Incendie véhicule, soyez vigilant !", ""]] call bis_fnc_showNotification;
};
...
_pos = [getPosATL creation_de_la_voiture_incendie select 0,getPosATL creation_de_la_voiture_incendie select 1,(getPosATL creation_de_la_voiture_incendie select 2)+1];
...
player globalChat format ["Salut %1, la SARL POMPIER à réussi à maitriser l'incendie de véhicule déclaré il y à peu ! Félicitation à eux pour leur bravoure.",name player];
