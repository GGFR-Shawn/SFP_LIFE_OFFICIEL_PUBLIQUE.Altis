...
if (player getvariable "ma_carte_identite" select 1 == "nom") exitwith {hint "! CARTE IDENTITE ! \n -------------------------------------------- \n \n Opération impossible, vous n'avez pas de carte ! \n\n Rendez vous en mairie pour en créer une. \n-------------------------------------------------\n www.sfpteam.fr \n By SFP Maxou";};

_avatar = player getvariable "ma_carte_identite" select 0;
_nom_carte_identite = player getvariable "ma_carte_identite" select 1;
_prenom_carte_identite = player getvariable "ma_carte_identite" select 2;
_sexe_carte_identite = player getvariable "ma_carte_identite" select 3;
_lieu_de_naissance_carte_identite = player getvariable "ma_carte_identite" select 4;
_taille_carte_identite = player getvariable "ma_carte_identite" select 5;
_heure_de_jeu = player getvariable "ma_date_de_naissance";
