...
{if (!isnil {_x getvariable "sarl_neomedia_en_ligne"}) then {_neomedia_en_ligne = true;};} foreach allunits;
if (isnil "_neomedia_en_ligne") exitwith {hint "! SFP TELECOM ! \n ----------------------------\n\n Désolé, aucun journaliste n'est connecté actuellement ! \n ------------------------------------- \n By SFP Maxou \n www.sfpteam.fr";};

if((ctrlText 11175) == "Pas d'insultes, ni de spam !") exitwith {Hint "! SFP TELECOM ! \n ----------------------------\n\n Pas d'insultes, ni de spam, ne peut pas être envoyé au DEPANNEURS ! \n ------------------------------------- \n By SFP Maxou \n www.sfpteam.fr";};
...
lemessageaneomedia = (ctrlText 11175);
publicVariable 'lemessageaneomedia';
closedialog 0;
...
_encouleur = parseText format ["! SFP TELECOM !<br/> ------------------------------------- <br/><br/> <t size='1.25' color='#8789F1'>Votre position :</t><br/><br/> <t size='1' color='#02E632'>%1</t>.<br/><br/> <t size='1.25' color='#8789F1'>Votre message :</t><br/><br/> <t size='1' color='#02E632'>%2</t>  <br/><br/> à bien été envoyé à NéoMédia <t size='1' color='#FC1400'>%3</t> !<br/> --------------------------------------------- <br/> By Maxou <br/> www.sfpteam.fr",ma_position_pour_le_chat, lemessageaneomedia,resultat_anonyme];
hint _encouleur;
...
_detail_du_message = format ["%1 (position : %2 et date de naissance : %3) à envoyé à NéoMédia le message : ----- %4 ---- Le message %5",name player, mapGridPosition player, player getvariable "ma_date_de_naissance", lemessageaneomedia, _statut_anonyme];
