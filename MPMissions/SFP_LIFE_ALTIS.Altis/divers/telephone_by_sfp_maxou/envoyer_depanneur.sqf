...
if (isnil "desdepanneurssontenjeu") exitwith {desdepanneurssontenjeu = nil; hint "! SFP TELECOM ! \n ----------------------------\n\n Désolé, aucun dépanneur n'est connecté actuellement ! \n ------------------------------------- \n By SFP Maxou \n www.sfpteam.fr";};
...
lemessageaudepanneur = (ctrlText 11175);
publicVariable 'lemessageaudepanneur';
closedialog 0;
...
_encouleur = parseText format ["! SFP TELECOM !<br/> ------------------------------------- <br/><br/> <t size='1.25' color='#8789F1'>Votre position :</t><br/><br/> <t size='1' color='#02E632'>%1</t>.<br/><br/> <t size='1.25' color='#8789F1'>Votre message :</t><br/><br/> <t size='1' color='#02E632'>%2</t>  <br/><br/> à bien été envoyé aux dépanneurs <t size='1' color='#FC1400'>%3</t> !<br/> --------------------------------------------- <br/> By Maxou <br/> www.sfpteam.fr",ma_position_pour_le_chat, lemessageaudepanneur,resultat_anonyme];
hint _encouleur;
...
_detail_du_message = format ["%1 (position : %2 et date de naissance : %3) à envoyé aux dépanneurs le message : ----- %4 ---- Le message %5",name player, mapGridPosition player, player getvariable "ma_date_de_naissance", lemessageaudepanneur, _statut_anonyme];
