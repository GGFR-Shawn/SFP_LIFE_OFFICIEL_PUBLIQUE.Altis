...
titletext ["Attention, un habitant est entrain de détruire un radar ... Consultez votre carte !","PLAIN DOWN"];
...
_marqueur_antenne_relais_destruction setMarkerTextLocal " Radar en sabotage !";
