...
if (player getvariable "temps_fatigue_niveau_3" <= 0) exitwith {hint "Désolé, tu n'as pas le niveau 3 ... \n\n Commence par la ;)";};
if (player getvariable "temps_fatigue_niveau_4" >= 1) exitwith {hint "Désolé, tu as déja le niveau 4 !";};
...
_distance_a_courrir = floor (400 + (random 250));
...
hint format ["! APTITUDE ! \n -------------------------------------------- \n \n Les %1 mètres ont bien été couru et tu valides donc l'épreuve 4 ! \n-------------------------------------------------\n www.sfpteam.fr \n By SFP Maxou",_distance_a_courrir_pour_message];	
player setVariable["temps_fatigue_niveau_4",1,false];
