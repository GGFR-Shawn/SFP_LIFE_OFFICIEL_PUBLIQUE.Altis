...
if (_nom_ajout_proprietaire in _nouveau_proprietaire) exitwith {hint format ["Désolé, %1 à déja les clefs du %2 !",_nom_ajout_proprietaire,getText ( configFile >> "CfgVehicles" >> typeOf(voiture_selectionne) >> "displayName")];};
