...
if (isClass(configFile >> "CfgVehicles" >> "SpeedRadar1")) then
{
	...
	if (!isnil "_le_radar") then
	{
		...
		{
			if ((round _vitesse_sfp >= 55) && (round _vitesse_sfp < 60)) then {le_prix_de_larticle = 90; _pointenmoins = 1; _condition = true;};
			if ((round _vitesse_sfp >= 60) && (round _vitesse_sfp < 70)) then {le_prix_de_larticle = 105; _pointenmoins = 2; _condition = true;};
			if ((round _vitesse_sfp >= 70) && (round _vitesse_sfp < 80)) then {le_prix_de_larticle = 135; _pointenmoins = 3; _condition = true;};
			if ((round _vitesse_sfp >= 80) && (round _vitesse_sfp < 90)) then {le_prix_de_larticle = 180; _pointenmoins = 4; _condition = true;};
			if ((round _vitesse_sfp >= 90) && (round _vitesse_sfp < 100)) then {le_prix_de_larticle = 230; _pointenmoins = 5; _condition = true;};
			if (round _vitesse_sfp >= 100) then {le_prix_de_larticle = 300; _pointenmoins = 12; _condition = true;};	
