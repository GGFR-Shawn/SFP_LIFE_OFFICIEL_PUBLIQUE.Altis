...
if (count listes_tableaux_chat < 1) exitwith {Hint "! SFP TELECOM ! \n ---------------------------- \n\n Désolé, vous n'avez personne en ligne dans votre répertoire ! \n ------------------------------------- \n By SFP Maxou \n www.sfpteam.fr";};
...
_a_qui_envoyer = [];
{
	_a_qui_envoyer pushback (_x select 0);
} foreach listes_tableaux_chat;

[[[ma_position_pour_le_chat, envoyeurdumessage, lemessage, _a_qui_envoyer],"divers\telephone_by_sfp_maxou\envoyer_mon_repertoire_synchro_message.sqf"],"BIS_fnc_execVM",true,false] spawn BIS_fnc_MP;
...
_detail_du_message = format ["%1 (position : %2 et date de naissance : %3) à envoyé à %4 : ----- %5 ---- Le message %6",name player, mapGridPosition player, player getvariable "ma_date_de_naissance", _a_qui_envoyer, lemessage, _statut_anonyme];
