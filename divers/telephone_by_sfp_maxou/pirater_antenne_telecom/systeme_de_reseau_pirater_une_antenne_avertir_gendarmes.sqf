...
titletext ["Attention, un habitant est entrain de pirater une antenne ... \n\n Consultez votre carte avant que celui ci envoi des messages anonymes !","PLAIN DOWN"];
...
_marqueur_antenne_relais_destruction setMarkerTextLocal " Antenne en piratage !";
