...
if (isnil "despompierssontenligne") exitwith {despompierssontenligne = nil; hint "! SFP TELECOM ! \n ----------------------------\n\n Désolé, aucun pompier n'est connecté actuellement ! \n ------------------------------------- \n By SFP Maxou \n www.sfpteam.fr";};
	
if((ctrlText 11175) == "Pas d'insultes, ni de spam !") exitwith {Hint "! SFP TELECOM ! \n ----------------------------\n\n Pas d'insultes, ni de spam, ne peut pas être envoyé aux POMPIERS ! \n ------------------------------------- \n By SFP Maxou \n www.sfpteam.fr";};
...
lemessageauxpompiers = (ctrlText 11175);
publicVariable 'lemessageauxpompiers';
closedialog 0;
...
_encouleur = parseText format ["! SFP TELECOM !<br/> ------------------------------------- <br/><br/> <t size='1.25' color='#8789F1'>Votre position :</t><br/><br/> <t size='1' color='#02E632'>%1</t>.<br/><br/> <t size='1.25' color='#8789F1'>Votre message :</t><br/><br/> <t size='1' color='#02E632'>%2</t>  <br/><br/> à bien été envoyé aux pompiers <t size='1' color='#FC1400'>%3</t> !<br/> --------------------------------------------- <br/> By Maxou <br/> www.sfpteam.fr",ma_position_pour_le_chat, lemessageauxpompiers,resultat_anonyme];
hint _encouleur;
...
_detail_du_message = format ["%1 (position : %2 et date de naissance : %3) à envoyé aux pompiers le message : ----- %4 ---- Le message %5",name player, mapGridPosition player, player getvariable "ma_date_de_naissance", lemessageauxpompiers, _statut_anonyme];
